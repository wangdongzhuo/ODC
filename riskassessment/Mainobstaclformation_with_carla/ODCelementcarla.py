...
class Mainobstaclformation:  # 感知主目标物信息
    ...
    @classmethod
    def mainob(cls, position_data):
        mainobdata = position_data
        # print("mainobdata", can_data['主目标信息'])
        if mainobdata != {}:
            Mainobstaclformation.launchstate = True
            Mainobstaclformation.posx = mainobdata['posx']
            Mainobstaclformation.posy = mainobdata['posy']
            Mainobstaclformation.relvelx = mainobdata['relvelx']
            Mainobstaclformation.relvely = mainobdata['relvely']
...
def dataupdate(can_data, driver_data, position_data):
    ...
    Mainobstaclformation.mainob(position_data)
