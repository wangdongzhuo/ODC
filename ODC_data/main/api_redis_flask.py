...
#     print("\n===== 服务启动完成 =====")
#     print(f"服务地址: http://127.0.0.1:5004")
#     print(f"文件列表: http://127.0.0.1:5004/list_protobufs")
#     print(f"获取trafficlightlist文件: http://127.0.0.1:5004/get_protobuf?filename=trafficlightlist")
#     print(f"获取lanelist文件: http://127.0.0.1:5004/get_protobuf?filename=lanelist")
#     print(f"获取location文件: http://127.0.0.1:5004/get_protobuf?filename=location")
#     print(f"获取mmobstacles文件: http://127.0.0.1:5004/get_protobuf?filename=mmobstacles")
